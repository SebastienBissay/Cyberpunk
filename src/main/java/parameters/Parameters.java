...
public final class Parameters {
    ...
    public static final long SEED = 18041988;
    public static final float NOISE_SCALE = 1 / 200f;
    public static final float NOISE_VELOCITY = .75f;
    public static final float NOISE_FORCE = .5f;
    public static final float NOISE_ANGULAR_MULTIPLIER = 8;
    public static final float NOISE_INNER_MULTIPLIER = .5f;
    public static final int NUMBER_OF_ANGLES = 4;
    public static final Color BACKGROUND_COLOR = new Color(8);
    public static final Color STROKE_COLOR_1 = new Color(255, 0, 218, 10.2f);
    public static final Color STROKE_COLOR_2 = new Color(0, 218, 255, 10.2f);
